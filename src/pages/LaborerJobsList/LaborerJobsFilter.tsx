...
interface LaborerJobsFilterProps {
    activeTab: 'laborer' | 'joblist';
    settings: any;
    wards: any[];
    filters: any;
...
const LaborerJobsFilter: React.FC<LaborerJobsFilterProps> = ({ activeTab, settings, wards, filters, onFilterChange }) => {
    return (
...
export default LaborerJobsFilter;
